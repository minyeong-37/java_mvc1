...
<body>
	<h2>회원가입</h2>
	<form action="joinProgram.jsp" name="frm" onsubmit="return chk()">
		<table border="1">
			<tr>
				<td>아이디</td>
				<td><input type="text" name="id" required="required">
				<input type="button" value="아이디 체크" onclick="winop()"></td>
			</tr>
			<tr>
				<td>암호</td>
			...
			<tr>
				...
				pattern="\d{2,3}-\d{3,4}-\d{4}" placeholder="010-xxxx-xxxx" title="2,3자리-3,4자리-4자리"></td>
			</tr>
			<tr>
